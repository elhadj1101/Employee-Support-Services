...
SECRET_KEY = "django-insecure-))7ar*40!eh_@2ec-xrl_ez%&6zyy2f(#q@2f@tk18q4)$g7@!"
...
DATABASES = {
        ...
        # 'HOST': 'ep-shiny-king-a242i51v-pooler.eu-central-1.aws.neon.tech',
        # 'NAME': 'verceldb',
        # 'USER': 'default',
        # 'PORT': 5432,
        # 'PASSWORD': '5z8AQXDalFBh'
    # }
...
DEFAULT_USER_MODEL = "authentication.Employee"
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {"anon": "20/day", "user": "1000/day"},
}
