...
export default function SideButton({ title, icon: Icon, nestedBtns }) {
  ...
  return (
    <div className=" mt-1">
      <div
        ...
        className="  flex items-center cursor-pointer text-white text-base font-medium justify-between py-2 px-4"
      >
            ...
            <Link
              ...
              className={`${
                path.split("/").pop() === location.pathname.split("/").pop()
                  ? "bg-[#4256D0]"
                  : "hover:bg-[#4256D0]"
              } mt-1 flex items-center gap-3 cursor-pointer text-white text-base font-medium py-2 px-4 rounded-[10px]`}
            >
              {Icon && <Icon className="text-lg" />}
