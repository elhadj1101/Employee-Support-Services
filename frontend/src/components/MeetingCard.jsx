...
export default function MeetingCard({online}) {
  const [open, setOpen] = useState(false);
  return (
    <div className="shadoww bg-white rounded-[30px] m-4 my-3 p-4 transition-all duration-500">
      <div className="flex  h-full items-center ">
      <div className="mr-10 flex flex-col items-center ">
    {online && (
      <div className={`w-24 ${open ? ' py-24 ' : 'h-20'} transition-all duration-500 bg-light-blue rounded-2xl p-2 text-white font-bold text-2xl flex items-center justify-center`}>
        13 Oct
      </div>
    )}
    {!online && (
      <div
        className={`w-24 ${open ? ' py-24 ' : 'h-20'} transition-all duration-500 bg-green-500 rounded-2xl p-2 text-white font-bold text-2xl flex items-center justify-center`}
      >
        13 Oct
      </div>
    )}
        ...
        <div className="w-full">
          ...
          { !online && <p className="text-green-500 text-sm capitalize font-semibold flex items-center">
              <div className="w-[6px] h-[6px] bg-green-500 rounded-full mr-[2px]" />
              online
            </p>}
           { online && <p className="text-light-blue text-sm capitalize font-semibold flex items-center">
          ...
          {open && (
            <div className="transition-all mt-2">
              ...
              <p>
                ...
                ipsam vero ab ullam, eos rem distinctio nesciunt in repellendus,
                voluptatum optio, quidem cupiditate ipsa eius! Eveniet vitae
                perferendis fugiat.
              </p>
              <p>Pv</p>
              file
